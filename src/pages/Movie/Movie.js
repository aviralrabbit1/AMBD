    ...
    return (
        <div className="movie">
            <div className="movie__intro">
                ...
                src={`https://image.tmdb.org/t/p/original${currentMovieDetail 
                ...
                <div className="movie__detailRight">
                    <div className="movie__detailRightTop">
                        <div className="movie__name">
                            {currentMovieDetail ? currentMovieDetail.original_title : ""}</div>
                        <div className="movie__tagline">
                            {currentMovieDetail ? currentMovieDetail.tagline : ""}</div>
            ...
            <div className="movie__links">
                <span className="movie__heading">Useful Links</span>
                {
                ...
                }
                {
                    ...
                    target="_blank" style={{textDecoration: "none"}}>
                        <p><span className="movie__imdbButton movie__Button">IMDb
                        <i className="newTab fas fa-external-link-alt"></i>
                        </span></p></a>
                }
            </div>
